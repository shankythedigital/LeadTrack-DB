...
//const { sendEmail } = require('../../config/ExpressServer');

// Call the function where appropriate, e.g., after a user signs up

// const mailer = require("../../config/emailService");
...
router.post("/register", async (req, res) => {
  try {
    ...
    existingUser.set({ company: cname, companyId: company.id });
    ...
    //await sendEmail(email,'Activation mail for Easy CRM','text',link);
    /*
